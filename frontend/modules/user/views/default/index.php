    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div id="myDiagramDiv"
                ...
                <canvas tabindex="0" width="904" height="598"
                        style="position: absolute; top: 0px; left: 0px; z-index: 2; user-select: none; width: 904px; height: 598px; cursor: auto;"></canvas>
            </div>
        </div>
    </div>
</div>
...
<script id="code">
    ...
    function init() {
            ...
            GOJS(go.Diagram, "myDiagramDiv",
                {
                    ...
                    nodeSelectionAdornmentTemplate: GOJS(go.Adornment, "Auto",
                        {layerName: "Grid"},  // the predefined layer that is behind everything else
                        GOJS(go.Shape, "Circle", {fill: "yellow", stroke: null}),
                        GOJS(go.Placeholder)
                    ),
                    layout:  // use a custom layout, defined below
                        GOJS(GenogramLayout, {direction: 90, layerSpacing: 30, columnSpacing: 10})
                });
        ...
        myDiagram.nodeTemplateMap.add("LinkLabel",
            GOJS(go.Node, {selectable: false, width: 1, height: 1, fromEndSegmentLength: 20}));
